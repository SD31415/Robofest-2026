...
import com.pedropathing.ftc.localization.localizers.PinpointGlitchlessLocalizer;
...
public class Constants {
    ...
    public static Follower createFollower(HardwareMap hardwareMap) {
        return new FollowerBuilder(followerConstants, hardwareMap)
                ...
                .setLocalizer(new PinpointGlitchlessLocalizer(hardwareMap, localizerConstants))
                .build();
    }
}
